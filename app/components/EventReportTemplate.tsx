            ...
            <div ref={ref} className="bg-white text-black w-[800px] max-w-[800px] min-h-[1123px] mx-auto overflow-hidden relative print:w-full print:max-w-none print:h-auto print:min-h-0" style={{ fontFamily: "Arial, sans-serif" }}>
                ...
                <table className="w-full border-collapse border-0 print:table">
                    <thead className="print:table-header-group">
                        <tr>
                            <th className="border-0 p-0 align-top h-40">
                                {/* HEADER - Placed inside TH so it repeats on every page in print */}
                    ...
                    <tbody>
                        <tr>
                            <td className="border-0 p-0 align-top">
                                {/* BODY - inner content table */}
                                <div className="px-10 pt-8 pb-12 z-20 relative">
                                    <table className="w-full border-collapse border border-black text-[13px] print:break-inside-auto">
                                        <tbody>
                                            {/* TITLE */}
                                            <tr>
